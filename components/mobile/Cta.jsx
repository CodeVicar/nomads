      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
          <h2 className="text-base font-semibold leading-7 text-[#fff]">
            Mobile-Centric Design Philosophy
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-[#fff] sm:text-4xl">
            Let's Innovate Together.
          </p>
          <p className="mt-6 text-base leading-7 text-[#fff]">
            With the surge in mobile & tablet usage, it's imperative that your
            application delivers an impeccable experience across all devices.
          </p>
          <p className="mt-6 text-base leading-7 text-[#fff]">
            Moreover, app stores prioritize applications that are optimized,
            responsive, and quick. Without a mobile-centric design, your app
            might not achieve its desired visibility or user engagement.
          </p>

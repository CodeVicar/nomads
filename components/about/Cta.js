          ...
          <div class="lg:pr-8 lg:pt-4">
            <div class="lg:max-w-lg">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">
                ...
                cover crucial expenses like driver payments, fuel costs, and
                routine maintenance.
              </p>
              <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                ...
                <div class="relative pl-9">
                  ...
                  <dd class="inline">
                    No hidden fees, no fine print. We believe in transparency
                ...
                <div class="relative pl-9">
                  ...
                  <dd class="inline">
                    Say goodbye to long waits and hello to fast, efficient
                    service. With WareFlow, you can access the funds you need

...
const cards = [
  {
    name: "Design",
    description:
      "We work closely with our clients to understand their requirements and create stunning visuals that accurately reflect their brand and messaging.",
    icon: PhoneIcon,
  },
  {
    name: "Development",
    description:
      "Our experienced team of developers use the latest coding technologies to create user-friendly, scalable, and efficient solutions that meet our clients' needs.",
    icon: LifebuoyIcon,
  },
  {
    name: "Testing and Quality Assurance",
    description:
      "We provide thorough testing and quality assurance to ensure that our solutions meet our high standards of quality, and function seamlessly across multiple devices.",
    icon: NewspaperIcon,
  },
];
